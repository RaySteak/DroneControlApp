...
public class JoystickView extends View
    ...
    */
    ...
    // square button
    private Paint mPaintSquareBorder;
    private Paint mPaintSquareBackground;
    ...
    private boolean mSquareJoystick;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(!mSquareJoystick)
            ...
            canvas.drawRect(mFixedCenterX - mBorderRadius, mFixedCenterY + mBorderRadius, mFixedCenterX + mBorderRadius, mFixedCenterY - mBorderRadius, mPaintBackground);
        // Draw the circle border
        if(!mSquareJoystick)
            canvas.drawCircle(mFixedCenterX, mFixedCenterY, mBorderRadius, mPaintCircleBorder);
        else
            canvas.drawRect(mFixedCenterX - mBorderRadius, mFixedCenterY + mBorderRadius, mFixedCenterX + mBorderRadius, mFixedCenterY - mBorderRadius, mPaintCircleBorder);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(!mSquareJoystick) {
            ...
            if(mPosX - mCenterX > mBorderRadius)
                mPosX = mBorderRadius + mCenterX;
            else if(mPosX - mCenterX < -mBorderRadius)
                mPosX = -mBorderRadius + mCenterX;

            if(mPosY - mCenterY > mBorderRadius)
                mPosY = mBorderRadius + mCenterY;
            else if(mPosY - mCenterY < -mBorderRadius)
                mPosY = -mBorderRadius + mCenterY;
        }
    ...
    public boolean isAutoReCenterButtonHorizontal() { return mAutoReCenterButtonHorizontal; }
    public boolean isSquareJoystick() { return mSquareJoystick; }
    ...
    public void setAutoReCenterButtonHorizontal(boolean b) { mAutoReCenterButtonHorizontal = b; }
    public void setSquareJoystick(boolean b) { mSquareJoystick = b; }
